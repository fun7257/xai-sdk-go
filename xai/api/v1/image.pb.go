...
type GenerateImageRequest struct {
	...
	// Optional storage options for persisting the generated image via Files API.
	// Residual: field numbers aligned with Python xai-sdk v6 descriptors; not yet
	// in public xai-org/xai-proto (see docs/PROTO.md).
...
// Options for storing a generated asset via the Files API.
type StorageOptions struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional filename for the stored asset.
	Filename string `protobuf:"bytes,1,opt,name=filename,proto3" json:"filename,omitempty"`
	// Optional TTL in seconds for the stored file.
...
// Options for creating a public URL for a stored asset.
...
// Metadata for a generated asset stored via the Files API.
...
type GeneratedImage struct {
	...
	// Present when the image was stored via storage_options.
...
type ImageUrlContent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Exactly one of image_url or file_id should be set.
	//
...
const file_xai_api_v1_image_proto_rawDesc = "" +
	...
	"\x05Image\x12H\n" +
	"\rGenerateImage\x12\x1d.xai_api.GenerateImageRequest\x1a\x16.xai_api.ImageResponse\"\x00B0Z.github.com/fun7257/xai-sdk-go/xai/api/v1;xaiv1b\x06proto3"
